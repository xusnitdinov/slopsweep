...
export function GitHubSignInButton({
  ...
  return (
    <form action={signInWithGitHub}>
      <button
        type="submit"
        className={`inline-flex w-full items-center justify-center gap-3 rounded-full bg-ink px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-ink/90 ${className}`}
      >
        <GitHubMark />
        {label}
      </button>
